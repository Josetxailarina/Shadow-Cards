...
public class CardState : MonoBehaviour
{
    ...
    [HideInInspector] public CardBehavior cardBehavior;
    ...
    private void Awake()
    {
        cardBehavior = GetComponentInChildren<CardBehavior>();
    ...
    public void AddElement(CardState elementalCard)
    {
        ...
        else
        {
            ...
            {
                cardBehavior.currentTableSlot.AddIceWall();
            }
    ...
    {
        currentHealth = 0;
        if (!cardBehavior.currentTableSlot.isEnemySlot)
        {
            cardBehavior.currentTableSlot.DisableAttackButton();
        }
        cardBehavior.currentTableSlot.isSlotEmpty = true;
        cardBehavior.currentTableSlot.currentCardInSlot = null;
        Destroy(gameObject);
    }
